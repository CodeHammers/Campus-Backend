...
MakanBr = Branch.create!(number_of_rooms: 4, address: "12 El Dokki Street, Dokki, Giza, Egypt", phone: "01117244030",
            email: "https://www.facebook.com/MakanCD/", workspace_id: Makan.id)
...
MaqarBr = Branch.create!(number_of_rooms: 1, address: "20 El Shaheed Mahmoud Fouad Street, Heliopolis, Cairo, Egypt.", phone: "01007744121",
            email: "https://www.facebook.com/AlMaqarr/", workspace_id: Almaqar.id)
...
FabLabBr = Branch.create!(number_of_rooms: 1, address: "Villa 35 - 100 St. - Near Al Horia Square - Maadi", phone: "01017465650",
            email: "https://www.facebook.com/fablab.egypt/", workspace_id: FabLab.id)
...
TheDistrictBr = Branch.create!(number_of_rooms: 1, address: "51B Egypt-Helwan Elzeraey Road, El Maadi, Cairo, Egypt.", phone: "0223802120",
                  email: "https://www.facebook.com/Districtspaces/", workspace_id: TheDistrict.id)
...
TYTBr1 = Branch.create!(number_of_rooms: 1, address: "5 Almessaha Square, Dokki, Giza, Egypt", phone: "01028888405",
                  email: "https://www.facebook.com/TYTEgypt/", workspace_id: TYT.id)
TYTBr2 = Branch.create!(number_of_rooms: 1, address: "10 Dr Handusa Street, Garden City, Cairo, Egypt", phone: "01028888405",
                  email: "https://www.facebook.com/TYTEgypt/1", workspace_id: TYT.id)
...
CreativoBr = Branch.create!(number_of_rooms: 1, address: "10 Husien Wasef St. Mesaha Square, Pizza hut building 3rd floor. Ad Duqqi, Cairo, Egypt", phone: "01111595410",
                  email: "https://www.facebook.com/creativo.egypt/", workspace_id: Creativo.id)
...
Branch.create!(number_of_rooms: Faker::Types.integer, address: Faker::Address.street_address, phone: Faker::PhoneNumber.phone_number,
                  email: "branch1@gmail.com", workspace_id: Workspace.all.to_a.sample.id)
Branch.create!(number_of_rooms: Faker::Types.integer, address: Faker::Address.street_address, phone: Faker::PhoneNumber.cell_phone,
...
Room.create!(price:Faker::Commerce.price, availability:1, capacity:Faker::Types.integer, services: Faker::Lorem.sentence , branch_id: Branch.all.to_a.sample.id)
Room.create!(price:Faker::Commerce.price, availability:1, capacity:Faker::Types.integer, services: Faker::Lorem.sentence , branch_id: Branch.all.to_a.sample.id)
Room.create!(price:Faker::Commerce.price, availability:1, capacity:Faker::Types.integer, services: Faker::Lorem.sentence , branch_id: Branch.all.to_a.sample.id)
Room.create!(price:Faker::Commerce.price, availability:1, capacity:Faker::Types.integer, services: Faker::Lorem.sentence , branch_id: Branch.all.to_a.sample.id)
Room.create!(price:Faker::Commerce.price, availability:1, capacity:Faker::Types.integer, services: Faker::Lorem.sentence , branch_id: Branch.all.to_a.sample.id)
...
IEEE = Organization.create!(name:"IEEE", phone:"01156084078", university: "Faculty of Engineering, Cairo University", email:"https://www.facebook.com/IEEECUSB/", 
...
Kvector = Organization.create!(name:"K Vector Foundation", phone:"0201150857984", university: "Faculty of Engineering, Cairo University", 
      email:"https://www.facebook.com/kvectorfoundation/", description: aboutKvector, logo: "https://imgur.com/a/2FfqE")
...
Baja = Organization.create!(name:"Baja racing team", phone:"01114542046", university: "Faculty of Engineering, Cairo University", 
      email:"https://www.facebook.com/BCURT.Racing.Team/", description: aboutBaja, logo: "https://imgur.com/a/4Pc8D")
...
Formula = Organization.create!(name:"Cairo Uni Formula racing team", phone:"01157084078", university: "Faculty of Engineering, Cairo University", 
      email:"https://www.facebook.com/curt.fs/?ref=br_rs", description: aboutFormula , logo: "https://imgur.com/a/1g9VT")
...
HPV = Organization.create!(name:"ASME HPV Cairo Uni", phone:"01092700716", university: "Faculty of Engineering, Cairo University", 
      email:"https://www.facebook.com/HPV.CUT/", description: aboutHPV, logo: "https://imgur.com/a/wyVil")
...
acmASCIS = Organization.create!(name:"acmASCIS", phone:"01156080078", university: "Faculty of computer science, Ain Shams university", 
      email:"https://www.facebook.com/acmASCIS/", description: aboutacmASCIS, logo: "https://imgur.com/a/PlpnH")
...
STP = Organization.create!(name:"STP", phone:"01152084078", university: "Faculty of Engineering, Cairo University", 
      email:"https://www.facebook.com/STP.Organization/", description: aboutSTP, logo: "https://imgur.com/a/G0ztb")
...
Enactus = Organization.create!(name:"Enactus", phone:"0224923769", university: "Cairo University", 
      email:"https://www.facebook.com/EnactusCairo/", description: aboutEnactus, logo: "https://imgur.com/a/enaH2")
...
SSS = Organization.create!(name:"SSS", phone:"0224923652", university: "Faculty of medicine, Cairo University", 
      email:"https://www.facebook.com/SSSKasrAlAiny/?ref=br_rs", description: aboutSSS, logo: "https://imgur.com/a/6ZRTZ")
...
ESL = Organization.create!(name:"ESL", phone:"01147905325", university: "Faculty of Engineering, Cairo University", 
      email:"https://www.facebook.com/ESL.CUFE/", description: aboutESL, logo: "https://imgur.com/a/tbkqV")
...
Image.create!(image_url: "https://imgur.com/a/es6fw", workshop_id: Ardunio.id)

Review.create!(feedback: "I have learned a lot", rating: 5, workshop_id:  Ardunio.id, user_id: User.all.to_a.sample.id)
...
Review.create!(feedback: "I have learned a lot", rating: 5, workshop_id:  Git.id, user_id: User.all.to_a.sample.id)
...
Event.create!(title: Faker::Lorem.word, description: Faker::Lorem.sentence, date: Faker::Date.forward(23), location:Faker::Address.city,  
      organization_id: Organization.all.to_a.sample.id, branch_id: Branch.all.to_a.sample.id, venue_name: Faker::GameOfThrones.city, schedule:Faker::Lorem.sentence)
Event.create!(title: Faker::Lorem.word, description: Faker::Lorem.sentence, date: Faker::Date.forward(23), location:Faker::Address.city,  
      organization_id: Organization.all.to_a.sample.id, branch_id: Branch.all.to_a.sample.id, venue_name: Faker::GameOfThrones.city, schedule:Faker::Lorem.sentence)
Event.create!(title: Faker::Lorem.word, description: Faker::Lorem.sentence, date: Faker::Date.forward(23), location:Faker::Address.city,  
      organization_id: Organization.all.to_a.sample.id, branch_id: Branch.all.to_a.sample.id, venue_name: Faker::GameOfThrones.city, schedule:Faker::Lorem.sentence)
...
Review.create!(feedback: Faker::Lorem.sentence, rating: Faker::Types.integer, branch_id: Branch.all.to_a.sample.id, user_id: User.all.to_a.sample.id)
Review.create!(feedback: Faker::Lorem.sentence, rating: Faker::Types.integer, branch_id: Branch.all.to_a.sample.id, user_id: User.all.to_a.sample.id)
Review.create!(feedback: Faker::Lorem.sentence, rating: Faker::Types.integer, branch_id: Branch.all.to_a.sample.id, user_id: User.all.to_a.sample.id)
Review.create!(feedback: Faker::Lorem.sentence, rating: Faker::Types.integer, branch_id: Branch.all.to_a.sample.id, user_id: User.all.to_a.sample.id)
Review.create!(feedback: Faker::Lorem.sentence, rating: Faker::Types.integer, branch_id: Branch.all.to_a.sample.id, user_id: User.all.to_a.sample.id)
Review.create!(feedback: Faker::Lorem.sentence, rating: Faker::Types.integer, branch_id: Branch.all.to_a.sample.id, user_id: User.all.to_a.sample.id)
Review.create!(feedback: Faker::Lorem.sentence, rating: Faker::Types.integer, branch_id: Branch.all.to_a.sample.id, user_id: User.all.to_a.sample.id)
Review.create!(feedback: Faker::Lorem.sentence, rating: Faker::Types.integer, organization_id: Organization.all.to_a.sample.id, user_id: User.all.to_a.sample.id)
Review.create!(feedback: Faker::Lorem.sentence, rating: Faker::Types.integer, organization_id: Organization.all.to_a.sample.id, user_id: User.all.to_a.sample.id)
Review.create!(feedback: Faker::Lorem.sentence, rating: Faker::Types.integer, organization_id: Organization.all.to_a.sample.id, user_id: User.all.to_a.sample.id)
Review.create!(feedback: Faker::Lorem.sentence, rating: Faker::Types.integer, organization_id: Organization.all.to_a.sample.id, user_id: User.all.to_a.sample.id)
Review.create!(feedback: Faker::Lorem.sentence, rating: Faker::Types.integer, organization_id: Organization.all.to_a.sample.id, user_id: User.all.to_a.sample.id)
...
Review.create!(feedback: Faker::Lorem.sentence, rating: Faker::Types.integer, organization_id: Organization.all.to_a.sample.id, user_id: User.all.to_a.sample.id)
Review.create!(feedback: Faker::Lorem.sentence, rating: Faker::Types.integer, organization_id: Organization.all.to_a.sample.id, user_id: User.all.to_a.sample.id)
Review.create!(feedback: Faker::Lorem.sentence, rating: Faker::Types.integer, workshop_id: Workshop.all.to_a.sample.id, user_id: User.all.to_a.sample.id)
Review.create!(feedback: Faker::Lorem.sentence, rating: Faker::Types.integer, workshop_id: Workshop.all.to_a.sample.id, user_id: User.all.to_a.sample.id)
Review.create!(feedback: Faker::Lorem.sentence, rating: Faker::Types.integer, workshop_id: Workshop.all.to_a.sample.id, user_id: User.all.to_a.sample.id)
Review.create!(feedback: Faker::Lorem.sentence, rating: Faker::Types.integer, workshop_id: Workshop.all.to_a.sample.id, user_id: User.all.to_a.sample.id)
Review.create!(feedback: Faker::Lorem.sentence, rating: Faker::Types.integer, workshop_id: Workshop.all.to_a.sample.id, user_id: User.all.to_a.sample.id)

class Review < ApplicationRecord
    ...
    def reviews_made_by_user (u_id)
        reviews = Review.where(user_id: :u_id)
        return reviews
    end

    public: reviews_to_organization, reviews_to_workshop, reviews_to_branch, reviews_made_by_user   
